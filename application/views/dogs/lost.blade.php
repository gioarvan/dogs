...
<div class="span12">
    ...
    <div class="span2">
        <div class="button-action">
            <a class="btn btn-flat btn-success btn-medium" href="{{ URL::to_action('dogs@addlost') }} ">Προσθήκη</a>
        </div>
    </div>
    <hr/>   
</div>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{ URL::to_action('dogs@editlost',array($dog->id)) }}">Επεξεργασία</a></li>
        ...
        <div class="span2">
            <div class="well widget box-shadow">
                ...
                <div class="searchbox-inner">
                    ...
                    <input type="hidden" name="page" value="L"/>

                    <div class="control-group">
                        {{ Form::submit('αναζήτηση',array('class'=>'btn btn-primary btn-small')) }}
                    </div>
                    {{ Form::close() }}
                </div>
            </div>
