...
<div class="row-fluid">
    <div class="span8">
        <div class="well widget">
            ...
            <div id="frm-addlost">
                {{ Form::open_for_files('dogs/editlost','POST',array('id'=>'editlost','enctype'=>'multipart/form-data')) }}
                ...
                @if(Session::has('success_editlost'))
                <div class="alert alert-success"> <a class="close" data-dismiss="alert" href="#">×</a>Η επεξεργασία έγινε με επιτυχία.</div>
                @endif
                <div class="row-fluid">
                    <div class="span4">
                        <div class="control-group">
                            <label class="control-label" for="dog_name">Όνομα&nbsp;<span class="required">*</span></label>
                            <div class="controls">
                                {{ Form::text('dog_name',$dog->dog_name,array('class'=>'input-medium tip','placeholder'=>'το όνομα του..','rel'=>'tooltip','title'=>'Συμπληρώστε το όνομα του.')) }}
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label for="dog_reward" class="control-label">Αμοιβή&nbsp;(&euro;)</label>
                            <div class="controls">
                                {{ Form::text('dog_reward',$dog->dog_reward,array('class'=>'input-medium tip','placeholder'=>'','rel'=>'tooltip','title'=>'Εάν το επιθυμείτε εισάγετε το ποσό αμοιβής που θέλετε να δώσετε.')) }}
                            </div>
                        </div>
                        <br style="clear:both"/>
    ...
    <div class="span4">
        ...
        <div class="span12">
            @if(isset($img))       
            <img src="{{ URL::base() }}/pictures/{{$img}}" alt=""/>
            @endif
            <div class="btn-toolbar">
                <div class="btn-group">
                    <a href="#" class="btn btn-inverse tip-bottom" title="Ο σκύλος μου βρέθηκε!"><i class="icon-white icon-thumbs-up"></i></a>\                                                              
                </div>
                <div class="btn-group">
                    <a href="#" class="btn btn-inverse tip-bottom" title="Αλλάξτε την φωτογράφια του"><i class="icon-white icon-refresh"></i></a>
                </div>
                <div class="btn-group">
                    <a href="#" class="btn btn-inverse tip-bottom" title="Διαγραφή σκύλου"><i class="icon-white icon-trash"></i></a>
                </div>                        
            </div>
        </div>
    </div>
