    ...
    <div class="span8">
        <div class="well widget">
            <div class="widget-header">
                <p><small>Συμπληρώστε την παρακάτω φόρμα για να καταχωρήσετε τον σκύλο που χάσατε.</small></p>
            </div>
            <div id="frm-addlost">
                {{ Form::open_for_files('dogs/addlost','POST',array('id'=>'addlost','enctype'=>'multipart/form-data')) }}
                ...
                @if(Session::has('success_addlost'))
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {{ Form::text('dog_name',Input::old('dog_name'),array('class'=>'input-medium tip','placeholder'=>'το όνομα του..','rel'=>'tooltip','title'=>'Συμπληρώστε το όνομα του.')) }}
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {{ Form::text('dog_reward',Input::old('dog_reward'),array('class'=>'input-medium tip','placeholder'=>'','rel'=>'tooltip','title'=>'Εάν το επιθυμείτε εισάγετε το ποσό αμοιβής που θέλετε να δώσετε.')) }}
                            </div>
                        </div>
                        <br style="clear:both"/>
                    ...
                    <div class="span6">
                        <div class="span3">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    {{ Form::text('dog_postal',Input::old('dog_postal'),array('class'=>'input-medium tip','placeholder'=>'','title'=>'Eισάγετε τον ταχυδρομικό κωδικό της περιοχής που χάσατε τον σκύλο.&nbsp;Για να δείτε τον χάρτη πατήστε προβολή.')) }}<br/><a href="#" class="s-map">προβολή χάρτη</a>
                                </div>
                            </div>
